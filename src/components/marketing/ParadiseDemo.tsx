        ...
        <Card className="demo-shell mt-8 overflow-hidden p-0">
          ...
          <LayoutGroup>
            <div className="grid gap-0 lg:grid-cols-[0.88fr_1.05fr_0.92fr]">
              <div className="border-b border-white/10 p-5 lg:border-b-0 lg:border-r lg:border-white/10 lg:p-6">
              ...
              <div className="relative border-b border-white/10 p-5 lg:border-b-0 lg:border-r lg:border-white/10 lg:p-6">
                ...
                <div className="mt-6 grid gap-5">
                  <div className="relative overflow-hidden rounded-[26px] border border-[rgb(var(--p-accent-rgb)/0.28)] bg-[radial-gradient(circle_at_top,rgb(var(--p-accent-rgb)/0.2),transparent_65%),rgba(255,255,255,0.04)] px-5 py-5 shadow-[0_0_42px_-22px_var(--p-glow)]">
                    <motion.div
                    ...
                    >
                      <div>
                        ...
                        <p className="mt-2 text-lg font-semibold text-white">Coordina, clasifica y decide el siguiente paso</p>
                      </div>
                      <span className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-white/10 text-[rgb(var(--accent-2)/0.96)]">
                    ...
                    >
                      {activeScenario.modules.map((module, idx) => (
                        <motion.div
                          ...
                          className="relative rounded-2xl border border-white/10 bg-white/[0.035] px-4 py-4 text-sm text-slate-200"
                        >
              ...
              <div className="p-5 lg:p-6">
                ...
                <AnimatePresence mode="wait">
                  <motion.div
                    ...
                    className="artifact-card mt-5 rounded-[26px] border border-emerald-400/30 bg-[linear-gradient(180deg,rgba(16,185,129,0.08),rgba(255,255,255,0.03))] p-5 shadow-[0_0_40px_-24px_rgba(16,185,129,0.6)]"
                  >
                    <motion.div layoutId="artifact-panel" transition={{ type: 'spring', stiffness: 260, damping: 30 }}>
                      <div className="flex items-center justify-between gap-3">
                        <div>
                          ...
                          <p className="mt-2 text-lg font-semibold text-white">{activeScenario.artifactTitle}</p>
                        </div>
                      ...
                      <div className="mt-5 space-y-3 rounded-[20px] border border-white/10 bg-night-950/55 p-4 font-mono text-[0.78rem] leading-relaxed text-slate-300">
