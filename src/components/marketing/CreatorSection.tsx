          ...
          <div className="grid gap-6 sm:gap-7 md:grid-cols-[0.88fr_1.12fr] md:items-center">
            <div className="flex items-center justify-center md:justify-start">
              <div className="relative">
                <div className="absolute -inset-2.5 rounded-[28px] bg-[rgb(var(--p-accent-rgb)/0.2)] blur-2xl sm:-inset-3 sm:rounded-[36px]" aria-hidden />
                <div className="relative h-48 w-48 overflow-hidden rounded-[24px] border border-[rgb(var(--p-accent-rgb)/0.35)] shadow-[0_18px_40px_-28px_rgba(124,58,237,0.6)] sm:h-60 sm:w-60 sm:rounded-[32px] md:h-72 md:w-72">
                  {!imageError ? (
                    <img
                      src="/IMG/foto.jpeg"
            ...
            <div>
              <h3 className="font-display text-[1.65rem] font-semibold text-white sm:text-2xl md:text-4xl">
